...
#    args = parser.parse_args()
    modelpth = '/home/CUSACKLAB/annatruzzi/cornet_models/'
    checkpoint = torch.load(modelpth+'latest_checkpoint.pth.tar')['state_dict']
    ...
    with open('/home/CUSACKLAB/annatruzzi/cichy2016/niko92_activations_pretrained_cornet.pickle', 'wb') as handle:
